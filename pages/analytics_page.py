...
def render(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.title("<i class='fas fa-bolt'></i> Analytics Avançado com IA", unsafe_allow_html=True)
    st.markdown("---")
    ...
    analytics_type = st.selectbox(
        ...
        [
            "<i class='fas fa-chart-bar'></i> Análise de Correlação",
            "<i class='fas fa-bullseye'></i> Segmentação de Aeroportos", 
            "<i class='fas fa-chart-line'></i> KPIs de Performance",
            "<i class='fas fa-crystal-ball'></i> Previsão de Demanda",
...
def render_correlation_analysis(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.subheader("<i class='fas fa-chart-bar'></i> Análise de Correlação", unsafe_allow_html=True)
...
def render_cluster_analysis(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.subheader("<i class='fas fa-bullseye'></i> Segmentação de Aeroportos", unsafe_allow_html=True)
...
def render_kpi_analysis(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.subheader("<i class='fas fa-chart-line'></i> KPIs de Performance", unsafe_allow_html=True)
...
def render_demand_forecasting(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.subheader("<i class='fas fa-crystal-ball'></i> Previsão de Demanda", unsafe_allow_html=True)
...
def render_ai_recommendations(PASTA_ARQUIVOS_PARQUET, ultimo_ano):
    st.subheader("<i class='fas fa-lightbulb'></i> Recomendações Inteligentes", unsafe_allow_html=True)
